...
// the JavaScript code to get the location of the user
map.locate({setView: true, maxZoom: 16});
// Just adding the location to the map without circle of accuracy
// map.on('locationfound')

// adding location tag and circle around it
...
// Adding error message if the location isn't found
